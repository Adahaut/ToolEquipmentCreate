...
public class SOCreateWindow : EditorWindow
{
    ...
    public void OnGUI()
    {
        ...
        if (editingEquipmentCopy != null)
        {
            ...
            EditorGUILayout.HelpBox("Save the equipment only in : Runtime/ScriptableObjects !", MessageType.Warning);
        }
    }
    ...
    private void SaveEquipment()
    {
        ...
        if (!AssetDatabase.Contains(selectedEquipment))
        {
            ...
            {
                errorMessage = null;
                string path = EditorUtility.SaveFilePanelInProject("Save Equipment", selectedEquipment.Name, "asset",
